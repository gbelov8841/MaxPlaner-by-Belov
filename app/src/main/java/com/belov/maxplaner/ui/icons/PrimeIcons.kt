...
object PrimeIcons {
    ...
    val Calendar = icon("Calendar") {
        ...
        moveTo(5f, 4f); horizontalLineTo(19f); quadTo(21f, 4f, 21f, 6f); verticalLineTo(20f)
        quadTo(21f, 22f, 19f, 22f); horizontalLineTo(5f); quadTo(3f, 22f, 3f, 20f)
        verticalLineTo(6f); quadTo(3f, 4f, 5f, 4f)
    ...
    val Health = icon("Health") {
        moveTo(12f, 21f); curveTo(8f, 18f, 2f, 13f, 2f, 7f)
        curveTo(2f, 2f, 8f, 1f, 12f, 6f); curveTo(16f, 1f, 22f, 2f, 22f, 7f)
        curveTo(22f, 13f, 16f, 18f, 12f, 21f)
    ...
    val Book = icon("Book") {
        moveTo(12f, 5f); curveTo(8f, 2f, 5f, 2f, 2f, 4f); verticalLineTo(21f)
        curveTo(5f, 19f, 8f, 19f, 12f, 22f); curveTo(16f, 19f, 19f, 19f, 22f, 21f)
        verticalLineTo(4f); curveTo(19f, 2f, 16f, 2f, 12f, 5f); verticalLineTo(22f)
    }
    val Shield = icon("Shield") {
        moveTo(12f, 2f); curveTo(9f, 4f, 6f, 5f, 3f, 5f); verticalLineTo(11f)
        curveTo(3f, 17f, 7f, 20f, 12f, 23f); curveTo(17f, 20f, 21f, 17f, 21f, 11f)
        verticalLineTo(5f); curveTo(18f, 5f, 15f, 4f, 12f, 2f)
        moveTo(8f, 12f); lineTo(11f, 15f); lineTo(17f, 9f)
    }
    val Wallet = icon("Wallet") {
        moveTo(20f, 7f); verticalLineTo(4f); horizontalLineTo(5f); quadTo(2f, 4f, 2f, 7f)
        verticalLineTo(19f); quadTo(2f, 22f, 5f, 22f); horizontalLineTo(21f); verticalLineTo(7f); horizontalLineTo(5f)
        moveTo(21f, 12f); horizontalLineTo(17f); quadTo(14f, 12f, 14f, 15f)
        quadTo(14f, 18f, 17f, 18f); horizontalLineTo(21f); moveTo(17f, 15f); horizontalLineTo(17.2f)
    }
    val Repeat = icon("Repeat") {
        moveTo(3f, 12f); verticalLineTo(9f); curveTo(3f, 5f, 6f, 3f, 10f, 3f); horizontalLineTo(20f)
        moveTo(16f, 0.9f); lineTo(20f, 3f); lineTo(16f, 6f)
        moveTo(21f, 12f); verticalLineTo(15f); curveTo(21f, 19f, 18f, 21f, 14f, 21f); horizontalLineTo(4f)
