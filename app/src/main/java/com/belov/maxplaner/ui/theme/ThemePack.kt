...
val ThemePacks = listOf(
    ...
    ThemePack("light_glass", "Light Glass", "Жемчужный свет · матовое стекло", false,
        ...
        SurfaceTokens(Color.White, .86f, Color(0xFF6D8393), .24f, Color(0xFFFAFBFB), elevation = 1.dp),
        StateTokens(.13f, .06f)),
    ThemePack("dark_future", "Dark Future", "Ночное небо · холодное свечение", true,
        ...
        ArtworkTokens(R.drawable.theme_dark_future, .12f, .44f, .90f, .7f, .16f),
    ...
    ThemePack("warm_style", "Warm Style", "Тёплый пейзаж · дымчатая бронза", true,
        ...
        ArtworkTokens(R.drawable.theme_warm_style, .20f, .46f, .90f),
        SurfaceTokens(Color(0xFF34261F), .82f, Color(0xFFE9D5BB), .19f, Color(0xFF2B211C), 16.dp, 11.dp, 1.dp, .04f), StateTokens(.19f), headingSerif = true),
